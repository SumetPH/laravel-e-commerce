...
<head>
    ...
    <link href="/assets/backEnd/css/paper-dashboard.css?v=2.0.0" rel="stylesheet" />
    <!-- CSS Just for demo purpose, don't include it in your project -->
    <link href="/assets/backEnd/demo/demo.css" rel="stylesheet" />
</head>
...
<body class="">
            ...
            <div class="logo">
                <a href="/" class="simple-text logo-mini">
                    <div class="logo-image-small">
                        <img src="/assets/backEnd/img/logo-small.png">
                    </div>
                </a>
                <a href="/" class="simple-text logo-normal">
                    Creative Tim
                    <!-- <div class="logo-image-big">
            <img src="/assets/backEnd/img/logo-big.png">
          </div> -->
                </a>
            </div>
            <div class="sidebar-wrapper">
                <ul class="nav">
                    <li class="{{ session()->get('admin-page') == 'dashboard' ? 'active' : null }}">
    ...
    <!--   Core JS Files   -->
    <script src="/assets/backEnd/js/core/jquery.min.js"></script>
    <script src="/assets/backEnd/js/core/popper.min.js"></script>
    <script src="/assets/backEnd/js/core/bootstrap.min.js"></script>
    <script src="/assets/backEnd/js/plugins/perfect-scrollbar.jquery.min.js"></script>
    <!--  Google Maps Plugin    -->
    ...
    <script src="/assets/backEnd/js/paper-dashboard.min.js?v=2.0.0" type="text/javascript"></script>
    <!-- Paper Dashboard DEMO methods, don't include it in your project! -->
    <script src="/assets/backEnd/demo/demo.js"></script>
    {{-- <script>
